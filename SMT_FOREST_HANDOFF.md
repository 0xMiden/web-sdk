...
| Wasm memory after open | 46.9 -> 8.6 MB | 610.8 -> 8.6 MB | wasm panic -> 8.6 MB |
| Witness read, warm median | 0.30 -> 1.25 ms | 0.25 -> 1.20 ms | 0.30 -> 1.20 ms |
| Transaction on the map account (execute + prove) | 3.12 s -> 3.01 s | n/a | n/a |
| Transaction on a small account, map tracked | 24.7 -> 23.4 ms | 85.6 -> 85.6 ms | n/a |
