...
* [FIX][web] `NoteAssets`'s constructor and `push` now throw a catchable error instead of panicking the WASM module when given more than 256 assets or a duplicate asset ([web-sdk#339](https://github.com/0xMiden/web-sdk/pull/339)).
