...
// ============================================================
// getCurrentBlockchainCheckpoint
// ============================================================
describe("getCurrentBlockchainCheckpoint", () => {
  it("returns the seeded empty peaks before any sync", async () => {
    const dbId = await openTestDb();
...
describe("error paths: unregistered dbId re-throws", () => {
  ...
  it("getCurrentBlockchainCheckpoint rejects on bad dbId", async () => {
    await expect(getCurrentBlockchainCheckpoint(BAD_DB)).rejects.toThrow();
  });
