...
/**
 * Create a wallet, faucet, or contract. A faucet sets `type`, a contract passes
 * `components`, and a wallet is the default (neither).
 */
...
export interface AccountsResource {
  /**
   * Create a new wallet, faucet, or contract account. Defaults to a wallet if
   * no options are provided.
   *
   * @param options - Account creation options. A faucet sets `type`, a contract
   *   passes `components`, and a wallet is the default.
   */
