# @miden-sdk/node-darwin-arm64 - Agent Guide
...
macOS on Apple Silicon. It carries no JavaScript, no type declarations and no public API.
...
2. the platform package for `darwin-arm64`, which is this one
